...
class HeroSliderOne extends Component{
    ...
    render(){
        ...
        let data = [
            {bgImg: 'slider3.jpg', sliderTitle: 'CUSTOM MADE POPCORN BOXES', sliderSubtitle: 'We can make your boxes in various shape and style.', btnLink: 'contact-us'},
            {bgImg: 'slider2.jpg', sliderTitle: 'CUSTOM MADE POPCORN BOXES', sliderSubtitle: 'We can make your boxes in various shape and style.', btnLink: 'contact-us'},
            {bgImg: 'slider1.jpg', sliderTitle: 'CUSTOM MADE POPCORN BOXES', sliderSubtitle: 'We can make your boxes in various shape and style.', btnLink: 'contact-us'}
        ];
